       ...
       // console.log("Rendering.....")
        return(
            ...
            <Banner></Banner>
                ...
                <article>
                    <MenuBar></MenuBar>
                    <Button id="dialog-btn" label="Show" icon="pi pi-external-link" onClick={() => this.onClick('displayBasic')} />
                    <Dialog id="app-dialog" header="Header" visible={this.state.displayBasic} style={{ width: '50vw' }} footer={this.renderFooter('displayBasic')} onHide={() => this.onHide('displayBasic')}>
